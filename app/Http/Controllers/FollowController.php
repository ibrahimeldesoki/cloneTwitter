...
class FollowController extends Controller
{
    ...
    public function follow(FollowRequest $followRequest)
    {
        ...
        $followEntity->setFollowingEntity($this->userService->find($followRequest->follower_user_id));
        $followEntity->setFollowerEntity($this->userService->find($followRequest->following_user_id));
